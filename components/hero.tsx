    ...
    <section className="relative isolate overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center justify-center py-14 sm:py-20">
          ...
          >
            <Image src="/icons/skitbit-white.svg" alt="Civic Digital Twin logo" width={32} height={32} className="h-8 w-8 animate-float" />
          ...
          {/* Phone grid - keeping original template structure */}
          <div 
...
function PhoneCard({
  title = "Risk",
  sub = "Real-time climate risk assessment",
  tone = "simulation",
...
const phoneData = [
  {
    title: "2.5D Maps",
    sub: "Interactive city visualization with heatmaps",
    tone: "live mapping",
  ...
  {
    title: "AI Copilot",
    sub: "Natural language scenario planning",
    tone: "intelligence",
  ...
  {
    title: "Scenarios",
    sub: "Test policies before implementation",
    tone: "simulation",
    gradient: "from-[#0b0b0b] via-[#1f2937] to-[#0b1220]",
  },
  {
    title: "Insights",
    sub: "Data-driven decision support",
    tone: "dashboard",
